FAC.TableContainsItem = function (items, table, ignoreCase)
    items = items or {}
    table = table or {}
...
FAC.PrintToUser = function(message)
    print(Ansicolors(message))
end

FAC.PrintToConsole = function(message)
    print(AnsiConsole(message))
end

FAC.RandomString = function(length)
    local result = ''
