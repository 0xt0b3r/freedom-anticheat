Locales['en'] = {
    ...
    -- Ban strings
    ['checking'] = '👮 𝗙𝗿𝗲𝗲𝗱𝗼𝗺 𝗔𝗻𝘁𝗶𝗖𝗵𝗲𝗮𝘁 | You are currently being checked...',
    ['user_ban_reason'] = '👮 𝗙𝗿𝗲𝗲𝗱𝗼𝗺 𝗔𝗻𝘁𝗶𝗖𝗵𝗲𝗮𝘁 | You have been banned from this server ( 𝗨𝘀𝗲𝗿𝗻𝗮𝗺𝗲: %s )',
    ['user_kick_reason'] = '👮 𝗙𝗿𝗲𝗲𝗱𝗼𝗺 𝗔𝗻𝘁𝗶𝗖𝗵𝗲𝗮𝘁 | You have been kicked ( 𝗥𝗲𝗮𝘀𝗼𝗻: %s )',
    ['banlist_ban_reason'] = 'Player has tried to trigger \'%s\' event',
    ['banlist_not_loaded_kick_player'] = '👮 𝗙𝗿𝗲𝗲𝗱𝗼𝗺 𝗔𝗻𝘁𝗶𝗖𝗵𝗲𝗮𝘁 | Our bans hasn\'t loaded, you\'ll have to wait a couple of seconds. Try again later!',
    ['ip_not_found'] = '👮 𝗙𝗿𝗲𝗲𝗱𝗼𝗺 𝗔𝗻𝘁𝗶𝗖𝗵𝗲𝗮𝘁 | We couldn\'t find your IP',
    ['ip_blocked'] = '👮 𝗙𝗿𝗲𝗲𝗱𝗼𝗺 𝗔𝗻𝘁𝗶𝗖𝗵𝗲𝗮𝘁 | You have a VPN active, disable it to join the server | Wrong? Contact the server owners',
    ['new_identifiers_found'] = '%s, new identifier(s) found - original ban %s',
    ['failed_to_load_banlist'] = '[Freedom AntiCheat] Failed to load Banlist!',
    ['failed_to_load_tokenlist'] = '[Freedom AntiCheat] Failed to load Tokenlist!',
    ['failed_to_load_ips'] = '[Freedom AntiCheat] Failed to load IPs!',
    ['failed_to_load_check'] = '[Freedom AntiCheat] Please check this error soon, Bans *will not* work!',
    ...
    -- Discord
    ['discord_title'] = '[Freedom AntiCheat] Has banned a player',
